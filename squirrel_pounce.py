# Squirrel Pounce (a 2D Katamari Damacy clone)
...
NUM_ENEMIES = 10    # number of enemies in the active area
ENEMY_MINSPEED = 5 # slowest enemy speed
ENEMY_MAXSPEED = 9 # fastest enemy speed
...
def runGame():
    ...
    winSurf = BASICFONT.render('You have outfoxed them squirrels!', True, WHITE)
